...
function initMap() {
    ...
    const showBtn = $('#show-markers');
    showBtn.click(showMarkers);
    const hideBtn = $('#hide-markers');
    hideBtn.click(hideMarkers);
    const deleteBtn = $('#delete-markers');
    deleteBtn.click(deleteMarkers);
