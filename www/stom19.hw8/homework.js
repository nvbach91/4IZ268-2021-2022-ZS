...
button1.addEventListener("click", placeInf1);  
...
button2.addEventListener("click", placeInf2);  
...
button3.addEventListener("click", placeInf3);  
...
button4.addEventListener("click", placeInf4);  
...
button5.addEventListener("click", placeInf5);  
...
button6.addEventListener("click", placeInf6);  
...
button7.addEventListener("click", placeInf7);  
...
button8.addEventListener("click", placeInf8);  
...
button9.addEventListener("click", placeInf9);  
...
function placeInf10() {
    ...
    p.innerText = isTriangle(10, 5, 8);
    resultText.appendChild(p);
}

button10.addEventListener("click", placeInf10);  
...
function placeInf11() {
    ...
    p.innerText = calculateTriangleArea(10, 5, 8);
    resultText.appendChild(p);
}

button11.addEventListener("click", placeInf11);  